...
<head>
    <meta charset="UTF-8">
    <title>ShareEventTogether - Mes inscriptions </title>
...
<div>
    ...
    <div class="evenement">
        ...
        $reponse = $bdd->query('SELECT ie.* , e.*, u.*, ce.* FROM inscription_evenements as ie left join evenements as e on ie.id_evenement = e.id_evenement 
